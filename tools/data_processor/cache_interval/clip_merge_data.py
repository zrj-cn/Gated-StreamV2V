...
def load_clip_score_data(clip_score_dir):
    ...
    for i in range(1,9):
        file_path = os.path.join(clip_score_dir, f'cache_interval_{i}.clipscore')
        if os.path.exists(file_path):
            with open(file_path, 'r') as f:
                ...
                clip_score_data[f'cache_interval_{i}'] = processed_data
...
def merge_data(motion_file, eval_file, clip_score_dir, output_file):
    ...
    for i in range(1,9):
        header.append(f'cache_interval_{i}_score')
...
def main():
    ...
    output_file = '/home/zrj/project/ori_v2v/streamv2v/tools/statistics/cache_interval/clip_merged_data.csv'
